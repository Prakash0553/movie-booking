...
const MyBookings = () => {
  ...
  // to store the movie booking data
  ...
  // we have to execute the above function whenever the component gets loaded
  useEffect(()=> {
    if(user){
      getMyBookings()
    }
    ...
    <div className='relative px-6 md:px-16 lg:px-30 pt-30 md:pt-40 min-h-[80vh]'>
      ...
      <h1 className='text-lg font-semibold mb-4'>My Bookings</h1>
      {
        bookings.map((item, index)=> (
          <div key={index} className='flex flex-col md:flex-row justify-between bg-primary/80
